...
interface KeyStatsColumnOneCardProps {
  emiten: string;
  keyStats: KeyStatsData;
}

// Helper to render a stats section
const renderSection = (title: string, items: KeyStatsItem[], maxItems: number = 6) => {
...
export default function KeyStatsColumnOneCard({ emiten, keyStats }: KeyStatsColumnOneCardProps) {
  return (
    <div className="glass-card-static" style={{ width: '350px', padding: '0.75rem 1rem' }}>
      ...
      <div className="compact-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <div className="compact-ticker" style={{ fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Key Stats 1</div>
        </div>
